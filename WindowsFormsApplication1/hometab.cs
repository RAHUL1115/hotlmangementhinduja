    ...
    public partial class hometab : UserControl
    {
        ...
        private void bunifuThinButton21_Click(object sender, EventArgs e)
        {
            ...
            if (Program.con.State == ConnectionState.Closed)
                Program.con.Open();
            string statement = "select room,coutdate from current_book where (cindate BETWEEN '2020-01-20' and '2020-02-01') or (coutdate BETWEEN '2020-01-20' and '2020-02-01')";
            SqlCommand cmd = new SqlCommand(statement, Program.con);
            ...
            string statement2 = "select room,coutdate from pre_book where (cindate BETWEEN '2020-02-01' and '2020-02-06') or (coutdate BETWEEN '2020-02-01' and '2020-02-06') ORDER BY cintime";
            cmd.Dispose();
            sdr.Close();
